...
e promoções da ASA Light.</td>
    ...
    <div class="corpo_um">
    	<div class="corpo_um_margin">
    		<div id="img_corpo_um">
            	<img src="img/img_comofunciona.png" alt="empresa" />
            </div>
            <div id="txt_corpo_um">
            	<img src="img/txt_comofunciona.png" alt="txt empresa" />
            </div>
            <div id="conteudo">
            	<table>
                	<tr>
                    	<td><font style="font-size:23px; color:#963e52;">Como Funciona o Serviço de Entregas ASA Light</font></td>
                    </tr>
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    <tr><td></td></tr>
...
Segunda a Sexta: 10:00 as 20:00 <br />
Sábado: 9:00 as 14:00 <br /><br />
...
Horário: 10:00 às 21:00<br />
Mínimo de 10 pratos
<p>
<b>ÁREAS DE ENTREGA</b><br />

• Niterói<br />
- Segunda a Sábado<br />
- Horário:<br />
- Mínimo: 5 pratos</br>
- Taxa de entrega:<br /><br />

• Rio de Janeiro<br />
- Zona Sul e Oeste: Terça-feira<br />
- Zona Norte e Centro: Quarta- feira<br />
- Mínimo: 10 pratos</br>
- Taxa de entrega:<br /><br />
...
- No ato da entrega: Dinheiro ou cartão <br />
- Pagamento Antecipado: On line
