...
<link rel="stylesheet" href="css/corpo_empresa_style.css" type="text/css" media="all" />
...
e promoções da ASA Light.</td>
    ...
    <div class="corpo_um">
    	<div class="corpo_um_margin">
    		<div id="img_corpo_um">
            	<img src="img/img_empresa.png" alt="empresa" />
            </div>
            <div id="txt_corpo_um">
            	<img src="img/txt_empresa.png" alt="txt empresa" />
            </div>
            <div id="conteudo">
            	<table>
                	<tr>
                    	<td><font style="font-size:23px; color:#963e52;">Conheça a ASA Light</font></td>
                    </tr>
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    <tr>
                    	<td><i>Estudei a ciência da nutrição e devo apresentar e incentivar aos meus pacientes os bons hábitos alimentares, assim como todos os benefícios de uma boa alimentação.<p>

Primeiramente devo informar que alimentar-se é muito mais do que matar a fome. O alimento é fonte de Energia, Beleza, Prevenção e redução do risco de doenças, longevidade, entre outros, não esquecendo o prazer que nos traz em saborear a boa culinária e o seu poder de unir a família e amigos ao redor das mesas.<p>

A idéia  ASA LIGHT surgiu com a mudança bem diante dos meus olhos a pedido dos meus  pacientes,pois estes alegavam que seguir uma dieta balanceada estava cada vez mais difícil, em virtude da correria do dia-a-dia e, principalmente pela inclusão das mulheres no mercado de trabalho, não havendo  mais tempo para a elaboração de uma comida saudável, equilibrada e saborosa. 
<p>
A ASA LIGHT  seria uma ferramenta útil, prática, acessível, saborosa e sem dúvida eficiente para atingir os resultados esperados na saúde e na estética. Desta forma teremos, uma nutrição adequada e vida prolongada!<p>

“O envelhecimento e a duração de nossa vida é determinado pela forma com que nós escolhemos comer e viver.”</i><p>

<b>Marcela Fróes</b><br />
Pós Graduada em Vigilancia Sanitária<br />
Pós Graduada em Nutrição Ortomolecular e Nutrigenômica<br />
Especializada em Gestão de Alimentos e Bebidas
                    ...
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                    	<td><b>Nossa Equipe</b><p>
Na ASA LIGHT suas refeições são elaboradas por nutricionistas e chefes de cozinha adequando e somando o SABOR e a SAÚDE na medida certa. 
Cada prato é elaborado cuidadosamente com nutrientes essenciais nas quantidades adequadas, visando um programa de reeducação alimentar.</td>
                    </tr>
                </table>
            </div>
        </div>
