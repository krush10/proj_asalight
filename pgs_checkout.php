...
class pgs_checkout {
   ...
   * @return               void
   */
  function pgs_checkout($args = array()) {
  ...
  function mostra ($args=array()) {
    ...
    $_form = array();
    if ($args['open_form'])
      $_form[] = '<form target="_self" action="https://pagseguro.uol.com.br/security/webpagamentos/webpagto.aspx" method="post" onmousedown="click()">';
    ...
    if ($args['show_submit']) {
      if ($args['img_button']) {
        ...
        $_form[] = '<input type="image" src="img/btn_concluir_compra.png" width="168" height="41" border="0" />';
      }
    }
