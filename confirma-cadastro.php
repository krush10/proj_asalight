...
<title>AsaLight - Confirmação de Cadastro</title>
    ...
    <div class="corpo_um">
    	<div class="corpo_um_margin">
            ...
            <div id="conteudo">
            	<table>
                	<tr>
                    	<td><font style="font-size:23px; color:#963e52;">Bem-Vindo a AsaLight</font></td>
                    </tr>
                </table>
                <table>
                	<tr><td>&nbsp;</td></tr>
                    <tr>
                    	<td>" Na ASA LIGHT suas refeições são elaboradas por nutricionistas e chefes de cozinha adequando e somando o SABOR e a SAÚDE na medida certa. Cada prato é elaborado cuidadosamente com nutrientes essenciais nas quantidades adequadas, visando um programa de reeducação alimentar. "</td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                    	<td>Uma mensagem de confirma&ccedil;&atilde;o foi enviada para voc&ecirc; por email.</td>
                    </tr>
                    <tr><td>&nbsp;</td></tr>
                    <tr>
                    	<td><a style="color:#963e52;" href='index.php'>Voltar a p&aacute;gina inicial</a></td>
                    </tr>
                </table>
            </div>
        </div>
