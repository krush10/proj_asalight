	...
	$(document).ready(function(){
		$('#cad_').validate({
			...
			messages:{
				...
				nome_usuario: {required: " campo é obrigatorio."},
				nome_completo: {required: " campo é obrigatorio."},
				cpf: {required: " campo é obrigatório."},
				data_nascimento: {required: " campo é obrigatório."},
				sexo: {required: " campo é obrigatório."},
				telefone_residencial: {required: " campo é obrigatório."},
				email: {required: " campo é obrigatório."},
				senha: {required: " campo é obrigatório.", minlength: " campo deve conter no mínimo 6 caracteres."},
				cep: {required: " campo é obrigatorio."},
				rua: {required: " campo é obrigatorio."},
				bairro: {required: " campo é obrigatorio."},
				cidade: {required: " campo é obrigatorio."},
				estado: {required: " campo é obrigatorio."},
				pais: {required: " campo é obrigatorio."},
				confirma_senha:{required: "",equalTo: " senhas estão diferentes."}
			}
		});
	});
</script>
...
e promoções da ASA Light.</td>
    ...
    <div class="corpo_um">
    	<div class="corpo_um_margin">
    		<div id="img_corpo_um">
            	<img src="img/img_login01.png" alt="programas" />
            </div>
            <div id="txt_corpo_um">
            ...
            <div id="conteudo">
            	<table cellspacing="10">
                	<tr>
                    	<td><font style="font-size:23px; color:#963e52;">Cadastro</font></td>
                    </tr>
                </table>
                <form id="cad_" action="function.cadastro.asalight/cadastrando.php" method="post">
                <table style="margin-left:-70px;">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="telefone_residencial" id="telefone_residencial" class="caixa_cadastro" /></td>
                    </tr>
                    <tr>
                    	<td align="right">Telefone Celular  -  (DDD - TELEFONE)</td>
                        <td><input type="text" name="telefone_celular" id="telefone_celular" class="caixa_cadastro" /></td>
                    </tr>
                    <tr>
            ...
            <div id="verifica_email_cadastrado" style="font-size: 12px; font-family:Arial, Helvetica, sans-serif; color:#F00; position:absolute; top:719px; margin-left:540px;"></div>
        </div>
    </div>
