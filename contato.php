...
<link rel="stylesheet" href="css/corpo_contato_style.css" type="text/css" media="all" />
...
e promoções da ASA Light.</td>
    ...
    <div class="corpo_um">
    	<div class="corpo_um_margin">
    		<div id="img_corpo_um">
            	<img src="img/img_contato.png" alt="contato" />
            </div>
            <div id="txt_corpo_um">
            	<img src="img/txt_contato.png" alt="txt contato" />
            </div>
            <div id="conteudo">
            	<table>
                	<tr>
                    	<td><font style="font-size:23px; color:#963e52;">Fale com a Asa Light</font></td>
                    </tr>
                </table>
                <table>
                	<tr><td>&nbsp;</td></tr>
                	<tr>
                    	<td>Para tirar dúvidas, fazer críticas ou elogios, utilize o formulário abaixo. </td>
                    </tr>
                    <tr>
                    	<td>Assim que possível entraremos em contato. Desde já agradecemos. </td>
                    </tr>
                </table>
                <table>
                	<tr><td>&nbsp;</td></tr>
                	<tr>
                    	<td>Seu nome:</td>
                        <td><input type="text" name="nome" class="caixa_header" style="background:#CCC; border:1px solid #CCC; width:400px;" /></td>
                    </tr>
                    <tr>
                    	<td>Seu e-mail:</td>
                        <td><input type="text" name="email" class="caixa_header" style="background:#CCC; border:1px solid #CCC; width:400px;" /></td>
                    </tr>
                    <tr>
                    	<td>Seu telefone:</td>
                        <td><input type="text" name="telefone" id="telefone" class="caixa_header" style="background:#CCC; border:1px solid #CCC; width:400px;" /></td>
                    </tr>
                    <tr>
                    	<td>Mensagem:</td>
                        <td><textarea name="mensagem" class="caixa_mensagem"></textarea></td>
                    </tr>
                </table>
                	<input type="image" src="img/btn_enviar.jpg" width="91" height="33" class="btn_enviar" />
            </div>
            <div id="tel_contato">
            	
                <font style="font-size:20px; color:#963e52;">
                <br /><br />
                <img src="img/nutricionista.png" /><br />
                Agende uma Consulta!<br />
                <b> 21 9451 4421</b><br />
                <a href="mailto:contato@asalight.com.br"><font size="2">contato@asalight.com.br</font></a>
            </div>
        </div>
    </div>
