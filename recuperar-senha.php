...
<title>AsaLight - Recuperar Senha</title>
...
e promoções da ASA Light.</td>
        ...
        <div id="area_admin">
        	<table>
                ...
                <tr>
                	<td><a href='#'><img src="img/btn_meucarrinho.png" alt="botao_carrinho" style='margin-left:-2px;' border="0" /></a></td>
                </tr>
            </table>
        </div>
	</div>
    ...
    <div class="corpo_um">
    	<div class="corpo_um_margin">
            ...
            <div id="conteudo">
            	<table>
                	<tr>
                    	<td><font style="font-size:23px; color:#963e52;">Recuperar Senha</font></td>
                    </tr>
                    <tr>
                    	<td>Insira seu email de acesso abaixo para recuperar sua senha</td>
                    </tr>
                </table>
                <form action="enviando-senha.php" method="post">
                <table>
                	<tr><td>&nbsp;</td></tr>
                	<tr>
                        <td><input type="text" name="email" class="caixa_header" value="Seu e-mail" style="background:#e2e2e2; border:1px solid #e2e2e2; height:28px; width:500px; font-size:14px; color:#333;" /></td>
                    </tr>
                </table>
...
a você.</p>
            ...
            <div id="area_consulta">
                ...
                <p>Tire suas dúvidas sobre alimentação e nutrição com nossa nutricionista.</p>
